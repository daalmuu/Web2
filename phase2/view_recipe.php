...
session_start();
// ===== a. التحقق من recipe id في query string =====
...
// ===== b. استرجاع معلومات الوصفة ومنشئها والكاتيقوري =====
$stmt = $conn->prepare("
    SELECT r.*, 
...
<header>
    <div class="header-container">
        <a href="User-dashboard.php"><img src="images/logo.png" alt="BellaCucina Logo" class="logo"></a>
        <nav class="nav-menu">
...
<main class="recipe-view-page">
    ...
    <div class="recipe-hero">
        <?php if (!empty($recipe['photofilename'])): ?>
            <img src="images/<?= htmlspecialchars($recipe['photofilename']) ?>" alt="Recipe Photo">
        <?php else: ?>
            <img src="images/default_recipe.jpg" alt="Recipe Photo">
        <?php endif; ?>
    ...
    <div class="recipe-info-box">
        <div class="creator-section">
            <?php if (!empty($recipe['creator_photo'])): ?>
                <img src="images/<?= htmlspecialchars($recipe['creator_photo']) ?>" class="chef-photo" alt="Chef">
            <?php else: ?>
                <img src="images/chef.png" class="chef-photo" alt="Chef">
            <?php endif; ?>
            <div>
    ...
    <div class="comments-section">
        ...
        <?php else: ?>
            <p><a href="index.php">Sign in</a> to leave a comment.</p>
        <?php endif; ?>
