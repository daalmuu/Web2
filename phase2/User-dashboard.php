        ...
        <div class="info-card">
            ...
            <div class="user-info">
                ...
                <div class="creator-avatar large">
                    <img src="images/<?= htmlspecialchars($user['photofilename']) ?>"
        ...
        <table class="data-table">
            ...
            <?php foreach ($recipesList as $row): ?>
                <tr>
                    ...
                    <td>
                        <img src="images/<?= htmlspecialchars($row['photofilename']) ?>" class="table-img">
                    </td>
                    <td>
                        <div class="creator-info">
                            <div class="creator-avatar">
                                <img src="images/<?= htmlspecialchars($row['userphoto']) ?>"
    ...
    <section class="table-section">
        ...
        <table class="data-table">
            ...
            <?php foreach ($favouritesList as $fav): ?>
                <tr>
                    <td>
                        <a href="view.php?id=<?= $fav['id'] ?>">
                            <?= htmlspecialchars($fav['name']) ?>
                        </a>
                    </td>
                    <td>
                        <img src="images/<?= htmlspecialchars($fav['recipephoto']) ?>" class="table-img">
                    </td>
                    <td>
