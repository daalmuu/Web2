...
<main class="recipe-view-page">
    ...
    <div class="recipe-hero">
        ...
        <div class="recipe-actions">
            ...
            <?php else: ?>
                <button type="button" class="action-btn favourite ajax-action" data-url="add_favourite.php?recipe_id=<?= $recipe_id ?>">❤ Favourite</button>
            <?php endif; ?>

            <?php if ($already_liked): ?>
                <button class="action-btn like" disabled style="opacity:0.45; filter:grayscale(60%);">👍 Like</button>
            <?php else: ?>
                <button type="button" class="action-btn like ajax-action" data-url="add_like.php?recipe_id=<?= $recipe_id ?>">👍 Like</button>
            <?php endif; ?>

            <?php if ($already_reported): ?>
                <button class="action-btn report" disabled style="opacity:0.45; filter:grayscale(60%);">🚩 Report</button>
            <?php else: ?>
                <button type="button" class="action-btn report ajax-action" data-url="add_report.php?recipe_id=<?= $recipe_id ?>">🚩 Report</button>
            <?php endif; ?>
